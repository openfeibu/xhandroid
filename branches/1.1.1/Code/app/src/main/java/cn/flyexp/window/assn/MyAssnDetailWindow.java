 ...
 */
public class MyAssnDetailWindow extends BaseWindow implements MyAssnDetailCallback.ResponseCallback, NotifyManager.Notify {
    ...
    @OnClick({R.id.img_back, R.id.img_menu, R.id.img_assnnotice, R.id.img_assnactivity, R.id.img_assnexamine})
