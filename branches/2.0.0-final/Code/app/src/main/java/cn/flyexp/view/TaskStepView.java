...
public class TaskStepView extends LinearLayout {
    ...
    private Drawable[] stateDrawable = new Drawable[2];
    ...
    private void initView() {
        ...
        stateDrawable[0] = context.getResources().getDrawable(R.mipmap.icon_selected_green);
        stateDrawable[1] = context.getResources().getDrawable(R.mipmap.icon_prompt_gray);
    ...
    public void showData(ArrayList<String> datas) {
        ...
        for (int i = 0; i < 4; i++) {
            if (len - 1 >= i) {
                stateDrawable[0].setBounds(0, 0, stateDrawable[0].getMinimumWidth(), stateDrawable[0].getMinimumHeight());
                tvState[i].setCompoundDrawables(null, stateDrawable[0], null, null);
                ...
                stateDrawable[1].setBounds(0, 0, stateDrawable[1].getMinimumWidth(), stateDrawable[1].getMinimumHeight());
                tvState[i].setCompoundDrawables(null, stateDrawable[1], null, null);
