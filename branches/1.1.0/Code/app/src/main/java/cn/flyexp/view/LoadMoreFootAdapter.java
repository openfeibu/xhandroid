 ...
 */
public class LoadMoreFootAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener, View.OnLongClickListener {

    private RecyclerView.Adapter adapter;

    private LoadMoreRecyclerView haoRecyclerView;
    ...
    public LoadMoreFootAdapter(LoadMoreRecyclerView haoRecyclerView, LoadingMoreFooter loadingMoreFooter, RecyclerView.Adapter adapter) {
