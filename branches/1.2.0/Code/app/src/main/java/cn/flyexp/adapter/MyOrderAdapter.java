...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.ViewHolder> {
    ...
    private ArrayList<MyTaskResponse.MyTaskResponseData> data = new ArrayList<>();
    private OnItemClickListener onItemClickListener;

    public MyOrderAdapter(Context context, ArrayList<MyTaskResponse.MyTaskResponseData> data) {
