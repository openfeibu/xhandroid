...
public class WithdrawalWindow extends AbstractWindow implements View.OnClickListener, TextWatcher {
    ...
    public WithdrawalWindow(MineViewCallBack callBack) {
        super(callBack);
    ...
    private void initView() {
        ...
        String account = getStringByPreference("alipay");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_withdrawal:
                ...
                callBack.verifiPayPwdEnter(Constants.PAY_RESULT_WITHDRAWAL);
                v.setEnabled(false);
                break;
        }
    }
